import { Subject, Task, Resource, INITIAL_SUBJECTS, INITIAL_TASKS, INITIAL_RESOURCES } from './mockData';
...
export const addResource = (resource: Omit<Resource, 'id' | 'addedAt'>): Resource => {
